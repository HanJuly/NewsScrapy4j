...
public class HttpClientUtils {
    ...
    private static CloseableHttpClient getCloseableHttpClient() {
        HttpHost httpHost =new HttpHost("47.102.115.83",8080);
        DefaultProxyRoutePlanner routePlanner = new DefaultProxyRoutePlanner(httpHost);
        CloseableHttpClient httpClient = HttpClients.custom().setConnectionManager(connectionManager).setRoutePlanner(routePlanner).build();
